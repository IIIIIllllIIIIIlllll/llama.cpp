...
struct llama_model_loader {
    ...
    struct llama_tensor_weight {
        ...
        llama_tensor_weight(const llama_file * file, uint16_t idx, const struct gguf_context * gguf_ctx, ggml_tensor * tensor, bool no_alloc = false) : idx(idx), tensor(tensor) {
